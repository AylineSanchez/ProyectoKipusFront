...
const Layout = ({ children }) => {
  ...
  const menuItems = [
    { path: '/evaluaciones', label: 'Mis evaluaciones' },
    { path: '/calefaccion', label: 'Evaluación de calefacción' },
    { path: '/agua', label: 'Evaluación sistema de agua' },
    { path: '/valoraciones', label: 'Valorar aplicación' },
    { path: '/comentarios', label: 'Enviar comentario' },
  ];
